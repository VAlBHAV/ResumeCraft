      ...
      >
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              <Heading as="h4" size="md">
                {about.name ? about.name : "Uzumaki Naruto"}
              </Heading>
              <Text color={"gray.500"}>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "uzumakinaruto@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+910020030004"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Leaf Village"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                ...
                {educationList.map((education) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"sm"}>
                        {school ? school : "Jaypee Institute of Information Technology"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
                      ...
                      >
                        ...
                        <Text>{grade ? grade : "7.4 CGPA"}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
